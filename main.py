...
async def handle_parse_chunk_and_extract():
    return await parse_chunk_and_extract("https://ctserc.org/documents/news/2017-07-25-RFP_for%20_legal_SERC_July17.pdf")